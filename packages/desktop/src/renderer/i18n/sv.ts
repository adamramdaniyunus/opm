export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av OPM",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av OPM har laddats ned. Vill du installera den och starta om programmet?",
