export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von OPM",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von OPM wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
