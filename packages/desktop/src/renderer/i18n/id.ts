export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terbaru OPM",
  ...
  "desktop.updater.downloaded.prompt":
    "OPM versi {{version}} telah diunduh. Apakah Anda ingin menginstalnya dan menjalankan ulang aplikasi?",
