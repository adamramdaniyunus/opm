export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di OPM",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di OPM è stata scaricata. Vuoi installarla e riavviare l'app?",
