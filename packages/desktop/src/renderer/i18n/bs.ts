export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju OPM-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} OPM-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
