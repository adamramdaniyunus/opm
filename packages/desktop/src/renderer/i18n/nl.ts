export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van OPM",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van OPM is gedownload. Wil je deze installeren en OPM opnieuw starten?",
