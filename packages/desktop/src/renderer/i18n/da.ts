export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af OPM",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af OPM er blevet downloadet. Vil du installere den og genstarte?",
