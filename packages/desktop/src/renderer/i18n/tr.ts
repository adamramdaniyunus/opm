export const dict = {
  ...
  "desktop.updater.none.message": "OPM'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "OPM'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
