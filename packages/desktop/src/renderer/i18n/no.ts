export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av OPM",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av OPM er lastet ned. Vil du installere den og starte på nytt?",
