...
import { compile, emitEffectImported, emitPromise, write } from "@opm/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "OPMEventEncoded",
              import: 'import type { OPMEventEncoded } from "@opm/protocol/groups/event"',
            },
          },
        }),
