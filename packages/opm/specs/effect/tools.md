...
Practical reference for the current tool-migration state in `packages/opm`.
...
Tool tests should use the existing Effect helpers in `packages/opm/test/lib/effect.ts`:
