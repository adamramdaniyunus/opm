import { ConfigV1 } from "@opm/core/v1/config/config"
...
import { NamedError } from "@opm/core/util/error"
...
import { SessionMessageTable } from "@opm/core/session/sql"
...
import { Shell } from "@opm/core/shell"
import { Snapshot } from "../../src/snapshot"
import { ToolRegistry } from "@/tool/registry"
import { Truncate } from "@/tool/truncate"
import { CrossSpawnSpawner } from "@opm/core/cross-spawn-spawner"
...
import { LocationServiceMap, locationServiceMapLayer } from "@opm/core/location-services"
...
it.instance("does not loop empty assistant turns for a simple reply", () =>
  Effect.gen(function* () {
    ...
    yield* llm.text("packages/opm/src/session/processor.ts")
