import type { JsonSchema, LLMRequest, ProviderMetadata } from "@opm/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@opm/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @opm/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
