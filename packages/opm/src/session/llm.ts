...
import { llmClient } from "@opm/core/effect/app-node-platform"
...
import type { LLMEvent } from "@opm/llm"
import { LLMClient } from "@opm/llm/route"
import type { LLMClientService } from "@opm/llm/route"
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @opm/llm. It
