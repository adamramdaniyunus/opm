import type { Hooks, PluginInput } from "@opm/plugin"
import type { Model } from "@opm/sdk/v2"
import { InstallationVersion } from "@opm/core/installation/version"
import { OauthCallbackPage } from "@opm/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. OPM will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
