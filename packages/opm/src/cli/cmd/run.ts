import type { PermissionV1 } from "@opm/core/v1/permission"
...
import { createOpencodeClient, type OpencodeClient, type ToolPart } from "@opm/sdk/v2"
...
export const RunCommand = effectCmd({
  command: "run [message..]",
  describe: "run opm with a message",
  ...
  builder: (yargs: Argv) =>
    yargs
      ...
      .option("attach", {
        type: "string",
        describe: "attach to a running opm server (e.g., http://localhost:4096)",
      })
      .option("password", {
        alias: ["p"],
        type: "string",
