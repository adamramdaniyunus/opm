...
import { normalizePromptContent } from "@opm/tui/editor"
...
import { OPENCODE_BASE_MODE, useBindings } from "@opm/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close OPM" } satisfies SlashOption,
    ]
