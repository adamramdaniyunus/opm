...
import type { AssistantMessage as OPMAssistantMessage, Message } from "@opm/sdk/v2"
import { InstanceRef } from "@/effect/instance-ref"
import { InstanceBootstrap } from "@/project/bootstrap"
import { InstanceStore } from "@/project/instance-store"
import { makeGlobalNode, Node } from "@opm/core/effect/app-node"
...
export type AssistantTokenCost = Pick<OPMAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<OPMAssistantMessage, "role"> &
  Partial<Pick<OPMAssistantMessage, "providerID" | "modelID">>
