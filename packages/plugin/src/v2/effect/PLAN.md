...
- Effect plugins import `@opm/plugin/v2/effect`, not `@opm/core`.
- Public domain values use generated `@opm/sdk` types.
...
- Define `PluginHost` domain capabilities in `@opm/plugin/v2/effect`.
