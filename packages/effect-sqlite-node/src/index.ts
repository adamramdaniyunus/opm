...
export const TypeId: TypeId = "~@opm/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@opm/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@opm/effect-sqlite-node/NodeSqliteClient")
