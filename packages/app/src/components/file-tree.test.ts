...
beforeAll(async () => {
  ...
  mock.module("@opm/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@opm/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@opm/ui/icon", () => ({ Icon: () => null }))
  mock.module("@opm/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
