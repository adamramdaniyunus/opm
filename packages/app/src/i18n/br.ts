export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do OPM",
  ...
  "desktop.menu.ariaLabel": "Menu do OPM",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o OPM",
  "desktop.recovery.terminated": "A janela do OPM foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O OPM não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do OPM",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O OPM não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do OPM foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo OPM",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no OPM.",
  ...
  "provider.connect.opencodeZen.line1":
    "OPM Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no OPM.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no OPM.",
  ...
  "dialog.server.description": "Trocar para qual servidor OPM este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o OPM...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o OPM em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o OPM...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o OPM em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o OPM em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o OPM",
  "wsl.onboarding.opencodeReadyIn": "O OPM está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O OPM está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o OPM em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o OPM",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OPM não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o OPM possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O OPM não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o OPM novamente.",
  ...
  "help.tabs.introduction": "Agora, o OPM Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do OPM ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do OPM",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: OPM ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "OPM inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor OPM dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do OPM",
  ...
  "settings.general.row.appearance.description": "Personalize como o OPM aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o OPM segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o OPM é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o OPM iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do OPM.",
