export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "OPMn tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja OPMssa.",
  ...
  "provider.connect.opencodeZen.line1":
    "OPM Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja OPMssa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja OPMssa.",
  ...
  "dialog.server.description": "Vaihda OPM-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan OPMa...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan OPMa kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään OPMa...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään OPMa kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä OPM jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä OPM",
  "wsl.onboarding.opencodeReadyIn": "OPM on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "OPM on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna OPM jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna OPM",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OPMa ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin OPM voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "OPM ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten OPM uudelleen.",
  ...
  "toast.update.description": "OPMn uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä OPM-tiimille",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että OPM ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "OPM sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita OPM-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda OPMn näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä OPM näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö OPM järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta OPMn teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun OPM käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät OPMn uusinta versiota.",
  ...
  "desktop.menu.documentation": "OPM-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "OPM-valikko",
  ...
  "desktop.recovery.loadFailed": "OPMn lataaminen epäonnistui",
  "desktop.recovery.terminated": "OPM-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "OPM ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "OPMn asennus epäonnistui",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "OPMa ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "OPMn päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "OPM Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
