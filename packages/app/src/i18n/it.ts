export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da OPM",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in OPM.",
  ...
  "provider.connect.opencodeZen.line1":
    "OPM Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in OPM.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in OPM.",
  ...
  "dialog.server.description": "Cambia il server OPM a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo OPM...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo OPM in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento OPM...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento OPM in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna OPM in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna OPM",
  "wsl.onboarding.opencodeReadyIn": "OPM è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "OPM è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa OPM in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa OPM",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OPM non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che OPM possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "OPM non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri OPM.",
  ...
  "help.tabs.introduction": "OPM Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di OPM ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team OPM",
  ...
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: OPM non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "OPM include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server OPM all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per OPM",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di OPM sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se OPM segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di OPM.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di OPM",
  ...
  "settings.updates.toast.latest.title": "OPM è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di OPM.",
  ...
  "desktop.menu.documentation": "Documentazione di OPM",
  ...
  "desktop.menu.ariaLabel": "Menu OPM",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare OPM",
  "desktop.recovery.terminated": "La finestra di OPM si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "OPM non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di OPM non riuscita",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "OPM non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di OPM è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
