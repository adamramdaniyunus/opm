export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de OPM",
  ...
  "desktop.menu.ariaLabel": "Menú de OPM",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar OPM",
  "desktop.recovery.terminated": "La ventana de OPM se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "OPM no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar OPM",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "OPM no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de OPM finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por OPM",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en OPM.",
  ...
  "provider.connect.opencodeZen.line1":
    "OPM Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en OPM.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en OPM.",
  ...
  "dialog.server.description": "Cambiar el servidor de OPM al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando OPM...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando OPM en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando OPM...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando OPM en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza OPM en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar OPM",
  "wsl.onboarding.opencodeReadyIn": "OPM está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "OPM está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala OPM en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar OPM",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OPM no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que OPM pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "OPM no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir OPM.",
  ...
  "help.tabs.introduction": "OPM Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de OPM ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de OPM",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: OPM aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "OPM incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor OPM dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para OPM",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve OPM en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si OPM sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de OPM.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia OPM",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de OPM.",
