export const dict = {
  ...
  "desktop.menu.documentation": "OPM-documentatie",
  ...
  "desktop.recovery.loadFailed": "OPM kan niet worden geladen",
  "desktop.recovery.terminated": "Het OPM-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "OPM reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van OPM is mislukt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "OPM is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De OPM-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door OPM",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in OPM te gebruiken.",
  ...
  "provider.connect.opencodeZen.line1":
    "OPM Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in OPM te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in OPM te gebruiken.",
  ...
  "dialog.server.description": "Wijzig met welke OPM-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "OPM controleren...",
  "wsl.onboarding.checkingOpencodeIn": "OPM controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "OPM bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "OPM bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk OPM bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "OPM bijwerken",
  "wsl.onboarding.opencodeReadyIn": "OPM is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "OPM is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer OPM in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer OPM",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OPM niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat OPM een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "OPM kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens OPM opnieuw.",
  ...
  "help.tabs.introduction": "OPM Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van OPM ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het OPM-team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: OPM ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "OPM bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de OPM-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor OPM",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe OPM eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of OPM het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van OPM aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer OPM wordt gestart",
  ...
  "settings.updates.toast.latest.title": "OPM is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van OPM.",
