export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل OPM",
  "desktop.recovery.terminated": "توقفت نافذة OPM بشكل غير متوقع",
  "desktop.recovery.unresponsive": "OPM لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت OPM",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "OPM غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث OPM، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من OPM",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في OPM.",
  ...
  "provider.connect.opencodeZen.line1":
    "يمنحك OPM Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في OPM.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في OPM.",
  ...
  "dialog.server.description": "تبديل خادم OPM الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من OPM...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من OPM في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث OPM...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث OPM في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث OPM في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث OPM",
  "wsl.onboarding.opencodeReadyIn": "OPM جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "OPM جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت OPM في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت OPM",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OPM غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن OPM من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على OPM التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح OPM.",
  ...
  "help.tabs.introduction": "أصبح OPM Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من OPM ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق OPM",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن OPM لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن OPM نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم OPM داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ OPM",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور OPM على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان OPM يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة OPM.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل OPM",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من OPM.",
