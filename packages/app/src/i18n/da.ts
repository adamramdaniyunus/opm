export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af OPM",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i OPM.",
  ...
  "provider.connect.opencodeZen.line1":
    "OPM Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i OPM.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i OPM.",
  ...
  "dialog.server.description": "Skift hvilken OPM-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker OPM...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker OPM i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer OPM...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer OPM i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater OPM i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater OPM",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OPM er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før OPM kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "OPM kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter OPM igen.",
  ...
  "toast.update.description": "En ny version af OPM ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til OPM-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, OPM understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "OPM inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør OPM-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for OPM",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan OPM ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om OPM skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas OPMs tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når OPM starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af OPM.",
  ...
  "desktop.recovery.loadFailed": "OPM kunne ikke indlæses",
  "desktop.recovery.terminated": "OPM-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af OPM mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "OPM er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af OPM er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "OPM Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
