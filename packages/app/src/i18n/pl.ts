export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja OPM",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać OPM",
  "desktop.recovery.terminated": "Okno OPM zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "OPM nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować OPM",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "OPM nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja OPM została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez OPM",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w OPM.",
  ...
  "provider.connect.opencodeZen.line1":
    "OPM Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w OPM.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w OPM.",
  ...
  "dialog.server.description": "Przełącz serwer OPM, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie OPM...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie OPM w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie OPM...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie OPM w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj OPM w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj OPM",
  "wsl.onboarding.opencodeReadyIn": "OPM jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "OPM jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj OPM w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj OPM",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OPM nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim OPM będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "OPM nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz OPM.",
  ...
  "help.tabs.introduction": "OPM Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja OPM ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu OPM",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: OPM nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "OPM zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer OPM wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla OPM",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd OPM na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy OPM ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw OPM.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania OPM",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji OPM.",
