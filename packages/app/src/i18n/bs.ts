export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za OPM",
  ...
  "desktop.menu.ariaLabel": "OPM meni",
  ...
  "desktop.recovery.loadFailed": "OPM se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor OPM-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "OPM ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija OPM-a nije uspjela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "OPM nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje OPM-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje OPM",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u OPM-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "OPM Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u OPM-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u OPM-u.",
  ...
  "dialog.server.description": "Promijeni na koji se OPM server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera OPM...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera OPM u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje OPM...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje OPM u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj OPM u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj OPM",
  "wsl.onboarding.opencodeReadyIn": "OPM je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "OPM je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj OPM u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj OPM",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OPM nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi OPM mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "OPM nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori OPM.",
  ...
  "help.tabs.introduction": "OPM Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija OPM-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku OPM timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: OPM još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "OPM uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni OPM server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u OPM-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako OPM izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li OPM prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu OPM-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se OPM pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju OPM-a.",
