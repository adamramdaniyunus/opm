export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi OPM",
  ...
  "desktop.recovery.loadFailed": "OPM gagal dimuat",
  "desktop.recovery.terminated": "Jendela OPM berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "OPM tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi OPM gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "OPM belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan OPM selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh OPM",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di OPM.",
  ...
  "provider.connect.opencodeZen.line1":
    "OPM Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di OPM.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di OPM.",
  ...
  "dialog.server.description": "Ganti server OPM mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa OPM...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa OPM di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui OPM...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui OPM di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui OPM di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui OPM",
  "wsl.onboarding.opencodeReadyIn": "OPM siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "OPM siap.",
  "wsl.onboarding.installOpencodeIn": "Instal OPM di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal OPM",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OPM belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum OPM dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "OPM tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali OPM.",
  ...
  "help.tabs.introduction": "OPM Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru OPM ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim OPM",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: OPM belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "OPM menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server OPM di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk OPM",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan OPM di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah OPM mengikuti tema sistem, terang, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema OPM.",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat OPM diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru OPM.",
