export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'OPM",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'OPM",
  "desktop.recovery.terminated": "La fenêtre OPM s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "OPM ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'OPM",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "OPM n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'OPM est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par OPM",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans OPM.",
  ...
  "provider.connect.opencodeZen.line1":
    "OPM Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans OPM.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans OPM.",
  ...
  "dialog.server.description": "Changez le serveur OPM auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'OPM...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'OPM dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'OPM...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'OPM dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour OPM dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour OPM",
  "wsl.onboarding.opencodeReadyIn": "OPM est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "OPM est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez OPM dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer OPM",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OPM non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'OPM puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "OPM n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez OPM.",
  ...
  "help.tabs.introduction": "OPM Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'OPM ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe OPM",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'OPM ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "OPM inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur OPM dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour OPM",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'OPM sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si OPM suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'OPM.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'OPM",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'OPM.",
