...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by OPM",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in OPM.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "OPM Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in OPM.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in OPM.",
  ...
  "dialog.server.description": "Switch which OPM server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking OPM...",
  "wsl.onboarding.checkingOpencodeIn": "Checking OPM in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating OPM...",
  "wsl.onboarding.updatingOpencodeIn": "Updating OPM in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update OPM in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update OPM",
  "wsl.onboarding.opencodeReadyIn": "OPM is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "OPM is ready.",
  "wsl.onboarding.installOpencodeIn": "Install OPM in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install OPM",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OPM not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before OPM can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "OPM could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen OPM.",
  ...
  "help.tabs.introduction": "OPM Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of OPM ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the OPM team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, OPM does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "OPM includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the OPM server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for OPM",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how OPM looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether OPM follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how OPM is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when OPM launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of OPM.",
