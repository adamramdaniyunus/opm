export const dict = {
  ...
  "desktop.recovery.loadFailed": "OPMを読み込めませんでした",
  "desktop.recovery.terminated": "OPMのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "OPMが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "OPMのインストールに失敗しました",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはOPMがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "OPMのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.model.unpaid.freeModels.title": "OPMが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、OPMで{{provider}}モデルを使用します。",
  ...
  "provider.connect.opencodeZen.line1":
    "OPM Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してOPMで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、OPMで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するOPMサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "OPMを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のOPMを確認中...",
  "wsl.onboarding.updatingOpencode": "OPMを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のOPMを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のOPMを更新してください。",
  "wsl.onboarding.updateOpencode": "OPMを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のOPMの準備ができました。",
  "wsl.onboarding.opencodeReady": "OPMの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にOPMをインストールしてください。",
  "wsl.onboarding.installOpencode": "OPMをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OPMがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "OPMでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、OPMをもう一度開いてください。",
  ...
  "help.tabs.introduction": "OPM Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "OPMの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをOPMチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: OPMはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "OPMには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でOPMサーバーを実行します。",
  ...
  "settings.general.row.language.description": "OPMの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのOPMの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "OPMがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "OPMのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "OPM の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "OPM は最新バージョンです。",
