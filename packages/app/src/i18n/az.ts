export const dict = {
  ...
  "desktop.recovery.loadFailed": "OPM yüklənə bilmədi",
  "desktop.recovery.terminated": "OPM pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "OPM cavab vermir",
  ...
  "desktop.wsl.error.installOpencode": "OPM quraşdırılması uğursuz oldu",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "OPM {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "OPM yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "OPM tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və OPM-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.opencodeZen.line1":
    "OPM Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və OPM-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və OPM-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu OPM serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "OPM yoxlanılır...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də OPM yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "OPM yenilənir...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də OPM yenilənir...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də OPM-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "OPM-u yeniləyin",
  "wsl.onboarding.opencodeReadyIn": "OPM {{distro}}-də hazırdır.",
  "wsl.onboarding.opencodeReady": "OPM hazırdır.",
  "wsl.onboarding.installOpencodeIn": "OPM-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "OPM quraşdırın",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OPM quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "OPM WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "OPM bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra OPM-u yenidən açın.",
  ...
  "help.tabs.introduction": "OPM Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "OPM-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı OPM komandasına",
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: OPM hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "OPM-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində OPM serverini işlət.",
  ...
  "settings.general.row.language.description": "OPM üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "OPM-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "OPM-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "OPM-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "OPM açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "OPM-un ən son versiyasından istifadə edirsiniz.",
