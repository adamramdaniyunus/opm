...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von OPM",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in OPM zu nutzen.",
  ...
  "provider.connect.opencodeZen.line1":
    "OPM Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in OPM zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in OPM zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den OPM-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.opencode": "OPM",
  ...
  "wsl.onboarding.checkingOpencode": "OPM wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "OPM in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "OPM wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "OPM in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie OPM in {{distro}}.",
  "wsl.onboarding.updateOpencode": "OPM aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "OPM ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "OPM ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie OPM in {{distro}}.",
  "wsl.onboarding.installOpencode": "OPM installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OPM nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor OPM einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "OPM konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann OPM erneut.",
  ...
  "toast.update.description": "Eine neue Version von OPM ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem OPM-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: OPM unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "OPM mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "OPM enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "OPM-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für OPM ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie OPM auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob OPM dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von OPM anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von OPM automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "OPM ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von OPM wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "OPM konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das OPM-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "OPM reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "OPM-Installation fehlgeschlagen",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "OPM ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das OPM-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "OPM Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
