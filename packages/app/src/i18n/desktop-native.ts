...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "OPM failed to load",
  "desktop.recovery.terminated": "OPM window terminated unexpectedly",
  "desktop.recovery.unresponsive": "OPM is not responding",
  ...
  "desktop.wsl.error.installOpencode": "OPM installation failed",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "OPM is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "OPM update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
