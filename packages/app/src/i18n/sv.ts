export const dict = {
  ...
  "desktop.recovery.loadFailed": "OPM kunde inte läsas in",
  "desktop.recovery.terminated": "OPM-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "OPM svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av OPM misslyckades",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "OPM är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "OPM-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av OPM",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i OPM.",
  ...
  "provider.connect.opencodeZen.line1":
    "OPM Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i OPM.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i OPM.",
  ...
  "dialog.server.description": "Växla vilken OPM-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar OPM...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar OPM i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar OPM...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar OPM i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera OPM i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera OPM",
  "wsl.onboarding.opencodeReadyIn": "OPM är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "OPM är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera OPM i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera OPM",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OPM är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan OPM kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "OPM kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan OPM igen.",
  ...
  "help.tabs.introduction": "OPM Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av OPM ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till OPM-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, OPM stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "OPM innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör OPM-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för OPM",
  ...
  "settings.general.row.appearance.description": "Anpassa hur OPM ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om OPM följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa OPMs tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när OPM startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av OPM.",
