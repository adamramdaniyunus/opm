...
export const dict = {
  ...
  "desktop.menu.documentation": "OPM-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "OPM-meny",
  ...
  "desktop.recovery.loadFailed": "OPM kunne ikke lastes inn",
  "desktop.recovery.terminated": "OPM-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "OPM svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av OPM mislyktes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "OPM er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av OPM er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av OPM",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i OPM.",
  ...
  "provider.connect.opencodeZen.line1":
    "OPM Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i OPM.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i OPM.",
  ...
  "dialog.server.description": "Bytt hvilken OPM-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av OPM ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til OPM-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at OPM ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "OPM inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør OPM-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for OPM",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan OPM ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om OPM skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i OPM.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når OPM starter",
  ...
  "settings.updates.toast.latest.title": "OPM er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av OPM.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker OPM...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker OPM i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer OPM...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer OPM i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater OPM i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater OPM",
  "wsl.onboarding.opencodeReadyIn": "OPM er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "OPM er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer OPM i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OPM er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før OPM kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "OPM kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter OPM på nytt.",
  ...
  "help.tabs.introduction": "OPM Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
