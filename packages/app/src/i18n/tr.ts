...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "OPM yüklenemedi",
  "desktop.recovery.terminated": "OPM penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "OPM yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "OPM kurulamadı",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "OPM, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "OPM güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "OPM tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve OPM'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "OPM Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak OPM'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak OPM'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi OPM sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "OPM kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde OPM kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "OPM güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde OPM güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki OPM'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "OPM'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde OPM hazır.",
  "wsl.onboarding.opencodeReady": "OPM hazır.",
  "wsl.onboarding.installOpencodeIn": "OPM'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "OPM'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OPM kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "OPM'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "OPM bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından OPM'u tekrar açın.",
  ...
  "help.tabs.introduction": "OPM Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "OPM'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı OPM ekibine",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: OPM henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "OPM ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "settings.desktop.wsl.description": "OPM sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "OPM'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "OPM'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "OPM'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "OPM'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "OPM başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "OPM'un en son sürümünü kullanıyorsunuz.",
