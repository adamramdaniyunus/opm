...
import defaultSoundPath from "@opm/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@opm/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@opm/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@opm/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@opm/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@opm/ui/audio/yup-01.mp3" with { type: "file" }
