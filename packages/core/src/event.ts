...
import type { Data, Definition, Payload } from "@opm/schema/event"
...
import { Durable } from "@opm/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@opm/schema/event").ID
export type { Data, Definition, Payload } from "@opm/schema/event"
