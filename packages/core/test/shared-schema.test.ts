...
import { SessionV2 } from "@opm/core/session"
import { Agent } from "@opm/schema/agent"
import { Location } from "@opm/schema/location"
import { Model } from "@opm/schema/model"
import { AgentAttachment, FileAttachment, Prompt, Source } from "@opm/schema/prompt"
import { Provider } from "@opm/schema/provider"
import { Project } from "@opm/schema/project"
import { ProjectDirectories } from "@opm/schema/project-directories"
import { PermissionV1 } from "@opm/schema/permission-v1"
import { Session } from "@opm/schema/session"
import { SessionInput } from "@opm/schema/session-input"
import { SessionMessage } from "@opm/schema/session-message"
import { Workspace } from "@opm/schema/workspace"
import { Command } from "@opm/schema/command"
import { Connection } from "@opm/schema/connection"
import { Credential } from "@opm/schema/credential"
import { FileSystem } from "@opm/schema/filesystem"
import { Integration } from "@opm/schema/integration"
import { LLM } from "@opm/schema/llm"
import { Permission } from "@opm/schema/permission"
import { Plugin } from "@opm/schema/plugin"
import { Pty } from "@opm/schema/pty"
import { Reference } from "@opm/schema/reference"
import { SessionTodo } from "@opm/schema/session-todo"
import { Skill } from "@opm/schema/skill"
import { AbsolutePath, DateTimeUtcFromMillis, optional, statics } from "@opm/schema/schema"
...
test("Core reuses the canonical shared schemas", async () => {
  const [
    ...
    import("@opm/core/command"),
    import("@opm/core/integration/connection"),
    import("@opm/core/credential"),
    import("@opm/core/filesystem"),
    import("@opm/core/integration"),
    import("@opm/core/location"),
    import("@opm/llm"),
    import("@opm/core/permission"),
    import("@opm/core/v1/permission"),
    import("@opm/core/project/copy"),
    import("@opm/core/pty"),
    import("@opm/core/project/schema"),
    import("@opm/core/reference"),
    import("@opm/core/session/input"),
    import("@opm/core/session/message"),
    import("@opm/core/session/todo"),
    import("@opm/core/session/prompt"),
    import("@opm/core/skill"),
    import("@opm/core/v2-schema"),
    import("@opm/core/schema"),
    import("@opm/core/workspace"),
  ])
