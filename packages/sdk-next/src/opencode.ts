import { OPM } from "@opencode-ai/client/effect"
...
import { createEmbeddedRoutes } from "@opm/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("OPM.create")(function* () {
  ...
  const client = yield* OPM.make({ baseUrl: "http://opencode.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@opm/sdk-next/OPM") {}
