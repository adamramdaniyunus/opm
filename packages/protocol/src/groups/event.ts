...
import type { Definition } from "@opm/schema/event"
...
export const OPMEvent = event.schema
export type OPMEvent = typeof OPMEvent.Type
export type OPMEventEncoded = typeof OPMEvent.Encoded
